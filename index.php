<?php
/*
Plugin Name: bKash Payment Gateway for WooCommerce by Shaffatur Khan 
Plugin URI:  https://shaffaturkhan.com/bKash-for-woocommerce
Description: This plugin helps users to integrate bkash payment gateway along with SMS API with woocommerce. bKash is money transfer systems of Bangladesh by facilitating money transfer through mobile phones. This plugin is an addon for woocommerce, so woocommerce is mandatory
Version:     2.10
Author:      Shaffatur Khan
...
add_action("admin_menu", "neetyit_add_sms_submenu_page");

function neetyit_add_sms_submenu_page(){
...
add_filter("woocommerce_thankyou_order_received_text", "neetyit_send_sms_when_order_received");

function neetyit_send_sms_when_order_received(){
...
add_action( 'wp_enqueue_scripts', 'neety_payment_method_script' );
function neety_payment_method_script(){
